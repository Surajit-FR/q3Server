...
export const getSingleUser = asyncHandler(async (req: Request, res: Response) => {
    ...
    return handleResponse(res, "success", 200, userData, "User fetched successfully")
});
...
export const getAllCustomer = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (customersDetails.length == 0) {
        return handleResponse(res, "success", 200, customersDetails, "Customers not found");
    }
    return handleResponse(res, "success", 200, customersDetails, "Customers fetched successfully");
});
...
export const getAllProviders = asyncHandler(async (req: Request, res: Response) => {
    ...
    if (providersDetails.length == 0) {
        return handleResponse(res, "success", 200, providersDetails, "Providers not found");
    }
    
    return handleResponse(res, "success", 200, providersDetails, "Providers fetched successfully");
